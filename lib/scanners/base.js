    ...
    this.init = function (networkIdentifier) {
        if (!_.isUndefined(networkIdentifier)) {
            ...
            var hasPermissions = function () {
                ...
                if (OS_ANDROID || (OS_IOS && (_.isUndefined(Ti.App.arguments.launchOptionsLocationKey) || Ti.App.arguments.launchOptionsLocationKey === false))) {
            ...
            if (OS_IOS) {
                ...
                if (version[0] < 5 || // Version < 5
                    (version[0] === 5 && version[1] === 0) // Version 5.0.*
                ) {
                    // BC: request permission the old way
